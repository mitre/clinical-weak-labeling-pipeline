from lib.termsets import LANGUAGES
...
class Negex:
    ...
    replace: bin; default: False
        indicator variable for extension or replacement of termset(s) lists (replaces when True; extends when False)
    pseudo_negations: list
